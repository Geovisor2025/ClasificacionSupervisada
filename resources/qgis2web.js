...
map.getView().fit([-8555059.370623, -2659706.671859, -5593577.209897, -1044238.177555], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = `
            ...
            <p class="title-medium">PRUEBA PILOTO - CLASIFICACIÓN SUPERVISADA</p>
...
var measureControl = (function (Control) {
    ...
    var measurementOption = [
        { value: "LineString", description: "Distnacia" },

var size = 0;
var placement = 'point';
function categories_ClasificacinSupervisadaELCARMENELDORADO_10(feature, value, size, resolution, labelText,
...
case 'PAPAYA':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(35,35,35,0.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.988}),fill: new ol.style.Fill({color: 'rgba(255,162,0,1.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_ClasificacinSupervisadaELCARMENELDORADO_10 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_ClasificacinSupervisadaELCARMENELDORADO_10(feature, value, size, resolution, labelText,
